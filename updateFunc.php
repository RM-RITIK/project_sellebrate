...
$sql = "UPDATE add_staff SET name = '$name', email = '$email', phone = '$phone', address = '$address', city = '$city', state = '$state', role = '$role', jDate = '$jdate', totalWorkingHours = '$time', salary = '$salary', active = '$active'  WHERE staff_id = '$id' ";
